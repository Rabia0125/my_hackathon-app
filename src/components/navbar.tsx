...
// import user from "../public/images/vector(12).png";
// import search from "../public/images/icn-settings-icn-xs(6).png";
// import cart from "../public/images/icn-settings-icn-xs(7).png";
// import mail from "../public/images/icn-settings-icn-xs(8).png";
        ...
        <div className="w-[324px] h-[54px] absolute top-[2px] left-[832px] flex justify-between items-center">
          <div className="w-[166px] h-[54px] p-[15px] flex items-center gap-[5px]">
            <div className="w-[12px] h-[12px] mt-[6px]">
              <Image src="/images/vector(12).png" alt="user" width={12} height={12} />
            </div>
          ...
          <ul className="flex gap-[15px] items-center">
            <li>
              <Image src="/images/icn-settings-icn-xs(6).png" alt="search" width={16} height={16} />
            </li>
            <li>
              <Image src="/images/icn-settings-icn-xs(7).png" alt="cart" width={16} height={16} />
            </li>
            <li>
              <Image src="/images/icn-settings-icn-xs(8).png" alt="mail" width={16} height={16} />
            </li>
          </ul>
        </div>
      </div>
