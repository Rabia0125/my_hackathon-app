    ...
    <div className="w-full absolute top-[1470px] left-0 flex justify-center">
      <div className="w-[1124px] py-[80px] flex flex-col gap-[80px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[30px]">
          {/* Product Cards */}
          {["/images/product-cover-5.png","images/product-cover-5 (1).png", "/images/product-cover-5 (2).png","/images/product-cover-5 (3).png",
          "images/product-cover-5 (4).png","/images/product-cover-5 (6).png","/images/product-cover-5 (6).png","/images/product-cover-5 (7).png"].map(
            (pic, index) => (
